...
from ..mcp4xxx_digipot_base import CONF_MCP4XXX_ID, mcp4xxx_digipot_base_component, mcp4xxx_digipot_base_ns, MCP4XXXWiperID
...
CHANNEL_OPTIONS = {
    ...
    '2': MCP4XXXWiperID.WIPER_2,
    '3': MCP4XXXWiperID.WIPER_3,
}
