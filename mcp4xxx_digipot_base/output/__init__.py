...
from .. import CONF_MCP4461_ID, mcp4xxx_digipot_base_component, mcp4xxx_digipot_base_ns, Mcp4461WiperIdx

DEPENDENCIES = ["mcp4xxx_digipot_base"]

Mcp4461Wiper = mcp4xxx_digipot_base_ns.class_(
    "Mcp4461Wiper", output.FloatOutput, cg.Parented.template(mcp4xxx_digipot_base_component)
)
...
CONFIG_SCHEMA = output.FLOAT_OUTPUT_SCHEMA.extend(
    {
        ...
        cv.GenerateID(CONF_MCP4461_ID): cv.use_id(mcp4xxx_digipot_base_component),
