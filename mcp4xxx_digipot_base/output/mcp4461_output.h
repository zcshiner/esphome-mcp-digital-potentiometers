...
class Mcp4461Wiper : public output::FloatOutput, public Parented<mcp4xxx_digipot_base_component> {
 public:
  Mcp4461Wiper(mcp4xxx_digipot_base_component *parent, Mcp4461WiperIdx wiper) : parent_(parent), wiper_(wiper) {}
